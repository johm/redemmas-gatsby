...
const EventTemplate = ({ data }) =>{
	...
	<InnerLayout>
	    ...
	    <SEO title={doc.name} image={getSrc(doc.Image)} />	
		...
		<div className="lg:ml-24 lg:mr-24 ">
		    ...
		    <div className="font-text text-2xl mb-3">{doc.Short_Description}</div>
		    <div className="font-text mb-3"><Markdown>{doc.Long_Description}</Markdown></div>
		    <div className="font-text mb-3"><Markdown>{doc.Author_bio}</Markdown></div>
