...
const Header = () => {
    ...
    return (
	<>
	    <div id="js-header" className="z-20 fixed top-0 right-0 bg-stone-900 w-[160px] md:w-[400px] h-16 flex p-1 md:p-3 md:gap-3 items-center font-subhed uppercase text-stone-100 ">
		...
		<div className="md:flex w-7 h-12  md:w-auto">
		    <button class="snipcart-checkout  md:px-1 border-2 border-transparent text-yellow-700 rounded-full hover:text-gray-400 focus:outline-none focus:text-gray-500 transition duration-150 ease-in-out" aria-label="Cart">
			<svg class="md:h-6 md:w-6 ml-[3px] h-5 w-5" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" stroke="currentColor">
