...
const Event = ({event}) => (
	...
	<div className="font-text">{event.Short_Description} 	{event.Withfriends_url &&  <a href={event.Withfriends_url} className="inline-block mt-1 text-center  rounded-full bg-violet-900 text-stone-100 font-subhed px-3 py-0.5 uppercase hover:bg-stone-800 transition-colors text-xs">RSVP on withfriends</a>}</div>
